...
//                icon = {
////                    Icon(
////                        imageVector = if (currentRoute == menuItem.route) Icons.Filled.Home else Icons.Outlined.Home,
////                        contentDescription = menuItem.title,
////                        tint = if (currentRoute == menuItem.route) Color.Black else Color.LightGray
////                    )
//                },
